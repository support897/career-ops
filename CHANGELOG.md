...
## [1.22.0](https://github.com/support897/career-ops/compare/career-ops-v1.21.0...career-ops-v1.22.0) (2026-07-31)
...
* 4 new job board providers + raise page caps + VIP gating ([e1c65ab](https://github.com/support897/career-ops/commit/e1c65ab1eb754283fd3dc3fa262b4918b6dc6002))
* 4 new providers + location-based scanning + Adzuna fix ([acecf80](https://github.com/support897/career-ops/commit/acecf80c18679e37dd849fcdee92bf0b3255ab4e))
* add applyToJob + apply() to LinkedIn/Indeed/SEEK providers for Lambda auto-apply ([823ef08](https://github.com/support897/career-ops/commit/823ef0877e791620a8e932464ffb3efe8cf369b2))
* Add dynamic support worker CV generation ([7b67508](https://github.com/support897/career-ops/commit/7b67508bd6697610e4bb597e6cb8975f9e5c09b2))
* admin API keys shared across all users ([f666371](https://github.com/support897/career-ops/commit/f666371ee8906e962c31a2d2c864999e50d2a10d))
* **apply:** warn before reapplying to a repeat company ([#1921](https://github.com/support897/career-ops/issues/1921)) ([e4307d0](https://github.com/support897/career-ops/commit/e4307d08a3524729432acd912d93440a9ac7f93e)), closes [#1920](https://github.com/support897/career-ops/issues/1920)
* AWS Lambda deployment for scanner ([7975a0f](https://github.com/support897/career-ops/commit/7975a0fbe8a96155123f961269e808f1eb32c716))
* batch create Gmail drafts for all 27 draft applications ([a815006](https://github.com/support897/career-ops/commit/a8150062fd5566132beca9317b71324d9e2fc7a7))
* batch Gmail drafts for all 544 jobs + auto-apply integration ([df9e293](https://github.com/support897/career-ops/commit/df9e293d6ea699d9c286e904d78673cde240e189))
* cloud pipeline phase 1-5 ([6e7d7a3](https://github.com/support897/career-ops/commit/6e7d7a3a46c2973a6d7f96b92fde567396fd9153))
* country-aware scan, per-user platform toggles, blank keyword defaults ([ac49d69](https://github.com/support897/career-ops/commit/ac49d69ab25ed8fbffa50bf82fa8447432e35cb4))
* **cover-letter:** support --format and --report CLI arguments ([#1830](https://github.com/support897/career-ops/issues/1830)) ([7750204](https://github.com/support897/career-ops/commit/77502047f103b31eee5f4c39552cc0c3d9b532cd)), closes [#1828](https://github.com/support897/career-ops/issues/1828)
...
* **dashboard:** manifesto shortcut, help entry and footer link ([8fb6008](https://github.com/support897/career-ops/commit/8fb6008af0828d121b22c4929343d9281eb268c3))
* DB-connected multi-user scanning ([31b2747](https://github.com/support897/career-ops/commit/31b2747428aa097192bedf9cb636069d31568c6c))
* **email:** add confirmed-time no-show follow-up variant ([#1860](https://github.com/support897/career-ops/issues/1860)) ([3e1bb69](https://github.com/support897/career-ops/commit/3e1bb6941e15021012685e554c456974d7be45c7)), closes [#1859](https://github.com/support897/career-ops/issues/1859)
* enhanced scoring, document generators, auto-apply toggle ([22b5f04](https://github.com/support897/career-ops/commit/22b5f04e60448db648cc763608b8b4a986cd689c))
* EventBridge setup script for hourly scan + daily digest ([417fb09](https://github.com/support897/career-ops/commit/417fb09f0f9b66296a443790564a3a1841175145))
...
* freemium tier + dry-run guards + VIP local runner ([5e05d7e](https://github.com/support897/career-ops/commit/5e05d7e3a645901a17587072876d3e28ecfdcba1))
* Gmail draft creation for VIP - NEVER sends, draft only ([a318ac4](https://github.com/support897/career-ops/commit/a318ac4171d51b047b895ed1e1e796003833b36d))
* **interview-prep:** cross-reference coffee chat notes against interview intel ([#1941](https://github.com/support897/career-ops/issues/1941)) ([652b22d](https://github.com/support897/career-ops/commit/652b22d84dff35dbfb52d0887800febfdcf73598)), closes [#1940](https://github.com/support897/career-ops/issues/1940)
* **interview-redflag:** flag scope/compensation mismatch as a separate fifth dimension ([#1943](https://github.com/support897/career-ops/issues/1943)) ([550eeef](https://github.com/support897/career-ops/commit/550eeefcefc7c1d2d91da8d339eae56a88d0ca8d)), closes [#1942](https://github.com/support897/career-ops/issues/1942)
* **interview-redflag:** suggest a ready-to-copy blacklist row at Reconsider level ([#1856](https://github.com/support897/career-ops/issues/1856)) ([f447fe4](https://github.com/support897/career-ops/commit/f447fe4be3e3fb4f0011abe5d68858b586001c1d)), closes [#1854](https://github.com/support897/career-ops/issues/1854)
* **interview/plan:** wire the existing Panel Intel table into multi-panelist rounds ([#1858](https://github.com/support897/career-ops/issues/1858)) ([08926e7](https://github.com/support897/career-ops/commit/08926e70140215d33ad86e86a55e7a7243f5fea8)), closes [#1857](https://github.com/support897/career-ops/issues/1857)
* **ledger:** immutable n: ordinal per signature + first-contribution question for new signers ([31a4f43](https://github.com/support897/career-ops/commit/31a4f431835f69a6c97de1e676a8b96466ecf024))
* **liveness:** add Workday to the zero-token ATS liveness API rung ([#1928](https://github.com/support897/career-ops/issues/1928)) ([74321c1](https://github.com/support897/career-ops/commit/74321c136bc610005581480b4fea3492702427d7))
* load API keys from DB for provider access ([635b53a](https://github.com/support897/career-ops/commit/635b53a96b0858cd41d9087d2db8114e1f28f2d4))
...
* multi-user auto-apply pipeline via --userId + DB ([2824e9f](https://github.com/support897/career-ops/commit/2824e9f513839c1b9274377e9fb0bec961b7f98d))
* **oferta:** Block G signal for benefits terminology country mismatch ([#1936](https://github.com/support897/career-ops/issues/1936)) ([8ef4c93](https://github.com/support897/career-ops/commit/8ef4c934fa2e4474b4d1fe16225160f1a18ef6df)), closes [#1935](https://github.com/support897/career-ops/issues/1935)
* **onboarding:** route to the manifesto from the README and the first successful scan ([bfae50f](https://github.com/support897/career-ops/commit/bfae50f76060e803723b11f4505fbc174b6d036e))
* **pdf:** add role name to the tailored PDF filename for multi-role tracking ([#1890](https://github.com/support897/career-ops/issues/1890)) ([d407bb5](https://github.com/support897/career-ops/commit/d407bb540c35d62f6b70e83dc7db2c9c058d4a11))
* per-user auto-apply score threshold from DB ([c4631d1](https://github.com/support897/career-ops/commit/c4631d16504df87a1870c597ce825f847107dc8c))
* per-user encrypted cookie management ([efa7e1f](https://github.com/support897/career-ops/commit/efa7e1f72fcd1533a59c95adc160dc7c0ed7573c))
* **providers:** add Oracle Recruiting Cloud zero-auth provider ([#1929](https://github.com/support897/career-ops/issues/1929)) ([0fbce60](https://github.com/support897/career-ops/commit/0fbce60a49901643b23490499be565da01f4991b))
* remove free-tier daily apply limit — auto-apply is now unlimited for all users ([a342e40](https://github.com/support897/career-ops/commit/a342e4045b81053234b1d9fe3b0bf53945406b95))
* **reports:** unified Risk Summary block joining the five company-risk signals ([#1738](https://github.com/support897/career-ops/issues/1738)) ([91e5b66](https://github.com/support897/career-ops/commit/91e5b66f9c9bf382399d07d6f9687eaec1748dc8)), closes [#1737](https://github.com/support897/career-ops/issues/1737)
* **salary-gap:** track compensation figures stated per interview round ([#1853](https://github.com/support897/career-ops/issues/1853)) ([b4466ca](https://github.com/support897/career-ops/commit/b4466ca96a2c543d76041f2937e031a65821c51b)), closes [#1852](https://github.com/support897/career-ops/issues/1852)
* **scan:** persist and surface the scanner trust signal to pipeline and history ([#1765](https://github.com/support897/career-ops/issues/1765)) ([6a912cc](https://github.com/support897/career-ops/commit/6a912cc218fb88fad98d9a760db8144e8e4e17b1)), closes [#1743](https://github.com/support897/career-ops/issues/1743)
* **scan:** track portal health over time and surface coverage decay ([#1768](https://github.com/support897/career-ops/issues/1768)) ([ecfc990](https://github.com/support897/career-ops/commit/ecfc9906bdf8b6a5e64c830485490da773a47f66)), closes [#1744](https://github.com/support897/career-ops/issues/1744)
* track portals.yml in repo so companies deploy with code ([00357b2](https://github.com/support897/career-ops/commit/00357b270a6a961d2305a514d5f7adf9ad0d48d9))
* VIP email automation + non-VIP platform-aware apply ([a16e33a](https://github.com/support897/career-ops/commit/a16e33af173646917ec181cee9373630d8bccc7f))
* VIP-only LLM scoring via Ollama (free, local) ([6791685](https://github.com/support897/career-ops/commit/6791685d3bde68ea3f5942193e0b067f0d302eb7))
* warmer, longer personalized emails in Lambda pipeline ([5509d0d](https://github.com/support897/career-ops/commit/5509d0d711b46ac02a2a91c6ffb875cd5d7db6a9))


### Bug Fixes

* 0 errors — HackerNews + Glints Indonesia + new providers ([805ad36](https://github.com/support897/career-ops/commit/805ad3694f0c1efbed43d2e285ce156fa491b4e4))
* 3 bugs found in audit ([5dd1b40](https://github.com/support897/career-ops/commit/5dd1b40a5fad717abc8a7934f7b45d24f1b55b81))
* add DATABASE_URL + ENCRYPTION_KEY to run-daily.sh for launchd ([aa94759](https://github.com/support897/career-ops/commit/aa9475903ee97fc10a2e1cd87576df6ba36ee7d4))
* auto-apply threshold from DB + cookie visibility + error isolation ([0b2f7de](https://github.com/support897/career-ops/commit/0b2f7dee291989388f0001f18cd9b90e2cb1c128))
* broken getUserApiKeys + 50-user limit for Jooble/Adzuna ([2268d3c](https://github.com/support897/career-ops/commit/2268d3c89d73e3c84610a4a71757cc50f1681389))
* **cv-template:** keep role header with its bullets when a location line is present ([#1903](https://github.com/support897/career-ops/issues/1903)) ([431e0ef](https://github.com/support897/career-ops/commit/431e0efcdac168e89059f6fc61940c628c824452))
...
* **doctor:** warn when Node is below 22.5 instead of passing silently ([#1831](https://github.com/support897/career-ops/issues/1831)) ([2fbe667](https://github.com/support897/career-ops/commit/2fbe66753eb4792a3b9da754279f0706681da42b)), closes [#1829](https://github.com/support897/career-ops/issues/1829)
* **envrc:** only load the Nix flake when Nix is installed ([#1863](https://github.com/support897/career-ops/issues/1863)) ([d92cfed](https://github.com/support897/career-ops/commit/d92cfedce3f8f2b0566a5ab7c7679e1c7dc57f0e))
* Gmail draft via IMAP with app password - no OAuth2 needed ([bef1d5b](https://github.com/support897/career-ops/commit/bef1d5baca054415a2909f9dbc9c42d919ec08c6))
* **interview-redflag:** drop GitHub PR references from candidate-facing output templates ([4a28ba3](https://github.com/support897/career-ops/commit/4a28ba3302113f1de8663934579ebf53300449d5))
* Lambda Dockerfile for Amazon Linux 2023 + missing deps ([d013132](https://github.com/support897/career-ops/commit/d01313227c5b248f850c037cb096d0eebe285163))
* Lambda output dir to writable /tmp, handler copies files to /tmp/career-ops ([8521064](https://github.com/support897/career-ops/commit/8521064f850317efe8b398ebe6a7eccbb5936677))
* **ledger-bot:** make the first-contribution confirmation copy match what ships ([f129ed9](https://github.com/support897/career-ops/commit/f129ed9a453b975a0e851ae0030a6f48201abfd9))
* **ledger-bot:** restore the 'done' confirmation now that the certificate render is live ([b31b3d7](https://github.com/support897/career-ops/commit/b31b3d7214dc21512827e79072fd880ddf782fc6))
...
* local cron runs with --userId for VIP auto-apply on job boards ([6b7aa3a](https://github.com/support897/career-ops/commit/6b7aa3ac5402601121c92dd6d3b990e92d7bb1cf))
* multi-tenant pipeline consumption bug in hourly scan ([789c6be](https://github.com/support897/career-ops/commit/789c6bef29f7e7e245bca7d39936407e3b579e87))
* **onboarding:** relay the manifesto note in agent-mediated updates ([8e76372](https://github.com/support897/career-ops/commit/8e763720643f1cfcb8586efd7f8b012c458997a2))
* **pdf:** drop empty Projects section instead of rendering a bare header ([#1879](https://github.com/support897/career-ops/issues/1879)) ([e7687da](https://github.com/support897/career-ops/commit/e7687da6d7669a39b7fc74f35c499ae7429f4636))
...
* remove conflicting root vercel.json (web/vercel.json is authoritative) ([702cb55](https://github.com/support897/career-ops/commit/702cb55d99a563127ce667341052e2cbe6e236c2))
...
* **role-matcher:** keep base titles distinct from specialized-suffix siblings ([#1922](https://github.com/support897/career-ops/issues/1922)) ([da230e3](https://github.com/support897/career-ops/commit/da230e3b3e0539b8f1407321afbe7419aa23a449)), closes [#1881](https://github.com/support897/career-ops/issues/1881)
* **scan-ats-full:** respect data/blacklist.md ([#1914](https://github.com/support897/career-ops/issues/1914)) ([e49aa7b](https://github.com/support897/career-ops/commit/e49aa7b990ae2491dc7ad6b74081b1569288ef96)), closes [#1911](https://github.com/support897/career-ops/issues/1911)
* **scan:** quiet dotenv so --json stdout stays parseable ([#1907](https://github.com/support897/career-ops/issues/1907)) ([4fe2b99](https://github.com/support897/career-ops/commit/4fe2b9964ca94fa18648bfb2e53686cc22183157)), closes [#1906](https://github.com/support897/career-ops/issues/1906)
...
* unify atomic report number allocation ([#1910](https://github.com/support897/career-ops/issues/1910)) ([af20cca](https://github.com/support897/career-ops/commit/af20cca4caf99c79ddb228f7e0247e14594074e9)), closes [#1733](https://github.com/support897/career-ops/issues/1733) [#1801](https://github.com/support897/career-ops/issues/1801) [#1835](https://github.com/support897/career-ops/issues/1835) [#1895](https://github.com/support897/career-ops/issues/1895)
* **update-system:** attribute the post-update manifesto link (utm_source=updater) ([6aa5c29](https://github.com/support897/career-ops/commit/6aa5c29037bf9f9e9ed5506bca759c03389efc03))
* **update-system:** surface commit failures instead of silently swallowing them ([#1855](https://github.com/support897/career-ops/issues/1855)) ([7d46e49](https://github.com/support897/career-ops/commit/7d46e49154b9af6ee93f361f658b391ef66cf1f3)), closes [#1844](https://github.com/support897/career-ops/issues/1844)
* **upskill:** keep fetched JD text as a string in the targeted --url-text path ([#1917](https://github.com/support897/career-ops/issues/1917)) ([d474011](https://github.com/support897/career-ops/commit/d47401166fe26ecf9c8843849ccdde67ad50ce75)), closes [#1894](https://github.com/support897/career-ops/issues/1894)
