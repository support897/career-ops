...
const EXPERIENCE_MAP = {
  automation: {
    ...
    proof: 'At APEX Website Solutions, she built a fully automated B2B lead generation engine that scrapes prospects, generates audit reports, sends cold emails, and books calls 24/7 with zero manual input.',
