...
sftp = ssh.open_sftp()
sftp.put(os.path.join(local_dir, "web/src/lib/db.ts"), f"{remote_dir}/web/src/lib/db.ts")
sftp.put(os.path.join(local_dir, "web/src/app/api/cv/route.ts"), f"{remote_dir}/web/src/app/api/cv/route.ts")
...
ssh.close()
print("Synced instant loading updates to VPS successfully!")
